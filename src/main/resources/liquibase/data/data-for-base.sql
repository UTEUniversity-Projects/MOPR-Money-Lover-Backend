...
INSERT INTO `oauth2_registered_client` (`id`, `client_id`, `client_id_issued_at`, `client_secret`, `client_secret_expires_at`, `client_name`, `client_authentication_methods`, `authorization_grant_types`, `redirect_uris`, `post_logout_redirect_uris`, `scopes`, `client_settings`, `token_settings`) VALUES
	('2f1e6400-9632-4e36-9c05-af642db77b3d', 'super_admin', '2025-03-09 20:18:18', NULL, NULL, NULL, 'none', 'authorization_code,refresh_token', '/api/oauth2/callback', NULL, 'openid,profile,email,offline_access', '{"@class": "java.util.LinkedHashMap", "requireProofKey": true, "requireAuthorizationConsent": false}', '{"@class": "java.util.LinkedHashMap", "accessTokenTimeToLive": null, "refreshTokenTimeToLive": null}, "reuseRefreshTokens": true'),
	('aa6de5a0-61a1-44ba-911c-6eec251200b0', 'admin', '2025-03-09 20:18:18', NULL, NULL, NULL, 'none', 'authorization_code,refresh_token', '/api/oauth2/callback', NULL, 'openid,profile,email,offline_access', '{"@class": "java.util.LinkedHashMap", "requireProofKey": true, "requireAuthorizationConsent": false}', '{"@class": "java.util.LinkedHashMap", "accessTokenTimeToLive": null, "refreshTokenTimeToLive": null}, "reuseRefreshTokens": true'),
	('b1284a3a-d525-48fa-a52c-ddd4aca84a89', 'manager', '2025-03-09 20:18:18', NULL, NULL, NULL, 'none', 'authorization_code,refresh_token', '/api/oauth2/callback', NULL, 'openid,profile,email,offline_access', '{"@class": "java.util.LinkedHashMap", "requireProofKey": true, "requireAuthorizationConsent": false}', '{"@class": "java.util.LinkedHashMap", "accessTokenTimeToLive": null, "refreshTokenTimeToLive": null}, "reuseRefreshTokens": true'),
	('c420383c-860f-4144-a75a-75086035fdb7', 'internal', '2025-03-09 20:18:18', NULL, NULL, NULL, 'none', 'authorization_code,refresh_token', '/api/oauth2/callback', NULL, 'openid,profile,email,offline_access', '{"@class": "java.util.LinkedHashMap", "requireProofKey": true, "requireAuthorizationConsent": false}', '{"@class": "java.util.LinkedHashMap", "accessTokenTimeToLive": null, "refreshTokenTimeToLive": null}, "reuseRefreshTokens": true'),
	('c421ad30-ca04-4d0f-8f18-e7953c42da5c', 'user', '2025-03-09 20:18:18', NULL, NULL, NULL, 'none', 'authorization_code,refresh_token', '/api/oauth2/callback', NULL, 'openid,profile,email,offline_access', '{"@class": "java.util.LinkedHashMap", "requireProofKey": true, "requireAuthorizationConsent": false}', '{"@class": "java.util.LinkedHashMap", "accessTokenTimeToLive": null, "refreshTokenTimeToLive": null}, "reuseRefreshTokens": true');
